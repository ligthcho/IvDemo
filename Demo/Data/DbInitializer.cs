		...
		public static void Initialize(SupplierContext context)
		{
			...
			if(!context.Supplier.Any())
			{
				...
				new Supplier{SupplierID="000345",SupplierName="辅料商",SupplierAbbr="fls",SupplierClassify="辅料供应商",
				 SupplierCompetentProducts="",SupplierBuyer="张生",SupplierProvince="广东省",SupplierCity="广州",SupplierAddress="越秀区某街道",SupplierEnable=((int)SupplierStatus.Normal).ToString(),SupplierType = new SupplierType{ TypeCode ="1001"}},
				new Supplier{SupplierID="001019",SupplierName="浩宇面料商",SupplierAbbr="hyml",SupplierClassify="",
				 SupplierCompetentProducts="",SupplierBuyer="李生",SupplierProvince="广东省",SupplierCity="厦门",SupplierAddress="厦门某街道",SupplierEnable= ((int)SupplierStatus.Normal).ToString(),SupplierType = new SupplierType{ TypeCode ="1001"}},
				new Supplier{SupplierID="001021",SupplierName="材料采购商",SupplierAbbr="",SupplierClassify="",
				 SupplierCompetentProducts="",SupplierBuyer="黄生",SupplierProvince="广东省",SupplierCity="深圳",SupplierAddress="深圳某街道",SupplierEnable= ((int)SupplierStatus.Normal).ToString(),SupplierType = new SupplierType{ TypeCode ="1001"}},
				new Supplier{SupplierID="001034",SupplierName="甲公司a",SupplierAbbr="",SupplierClassify="",
				 SupplierCompetentProducts="",SupplierBuyer="郭生",SupplierProvince="湖南省",SupplierCity="香港",SupplierAddress="香港某街道",SupplierEnable= ((int)SupplierStatus.Disabled).ToString(),SupplierType = new SupplierType{ TypeCode ="1002"}},
				new Supplier{SupplierID="001049",SupplierName="面料加工商",SupplierAbbr="mljgs",SupplierClassify="面料供应商",
				 SupplierCompetentProducts="",SupplierBuyer="羊生",SupplierProvince="广东省",SupplierCity="广州",SupplierAddress="番禺区某街道",SupplierEnable= ((int)SupplierStatus.Normal).ToString(),SupplierType = new SupplierType{ TypeCode ="1003"}},
